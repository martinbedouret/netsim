...
if (!file_exists(DB_FILE)) {
	...
	echo "<p>No se encontró ningún archivo de base de datos en ".DB_FILE.", intentando crearlo ahora ...</p>\n";
	...
	try {
		...
		echo "<p>¡La base de datos se inicializó con éxito! <a href=\"./\">Seguir...</a></p>\n";
	} catch (Exception $e) {
		echo "<p>Fracasado en la creación de archivos: ".$e->getMessage()."</p>\n";
	}
